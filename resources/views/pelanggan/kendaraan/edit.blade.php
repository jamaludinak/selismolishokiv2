    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 py-8">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('kendaraan.update', $kendaraan->id) }}" enctype="multipart/form-data" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="group">
                                ...
                                <input type="number" id="tahun_pembelian" name="tahun_pembelian" 
                                       min="2000" max="{{ date('Y') + 1 }}" value="{{ $kendaraan->tahun_pembelian }}" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200">
                            ...
                            <div class="group">
                                ...
                                <input type="date" id="tanggal_berakhir_garansi" name="tanggal_berakhir_garansi" 
                                       value="{{ $kendaraan->tanggal_berakhir_garansi ? date('Y-m-d', strtotime($kendaraan->tanggal_berakhir_garansi)) : '' }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t border-gray-200">
                        <button type="submit" 
                                class="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center group">
                            <i class="fas fa-save mr-2 group-hover:scale-110 transition-transform"></i>
                            Update Kendaraan
                        </button>
                        <a href="{{ route('kendaraan.show', $kendaraan->id) }}" 
                           class="flex-1 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center group">

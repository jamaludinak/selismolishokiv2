...
@section('content')
    ...
    <div class="container mx-auto py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('alamat.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah
                Alamat</a>
        </div>
        @if (session('success'))
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">
                                <a href="#" onclick="showMap({{ $a->latitude }}, {{ $a->longitude }})"
                                    class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600">Lihat Lokasi</a>
                            </td>

...
@section('content')
    <div class="text-left py-8 ml-8">
        <button onclick="window.history.back()"
            class="bg-white-500 text-black px-6 py-2 rounded-sm shadow-md hover:bg-yellow-100 transition duration-300 mt-24">
            <- Kembali </button>
    </div>

    <div class="container mx-auto px-4 md:px-0 mt-4">
        <h2 class="text-xl md:text-4xl font-bold mb-8 text-center">Hubungi Kami</h2>
        <p class="text-lg md:text-xl mb-8 text-center">Kami siap membantu Anda dengan segala kebutuhan sepeda listrik Anda.
            Berikut adalah cara untuk menghubungi kami:</p>
    </div>
    <!-- Contact Us Section -->
        ...
        <a href="https://www.instagram.com/selismolishokiofficial/" class="md:order-2">
            <div class="bg-white border-4 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div>
                    ...
                    <a href="https://www.instagram.com/selismolishokiofficial/"
                        class="text-black text-xl hover:text-gray-300">@selismolishokiofficial</a>
                </div>
            </div>
        </a>
        ...
        <a href="mailto:info@selismolishoki.com" class="md:order-4">
            <div class="bg-white border-4 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div>
                    ...
                    <a href="mailto:info@selismolishoki.com"
                        class="text-black text-xl hover:text-gray-300">info@selismolishoki.com</a>
                </div>
            </div>
        </a>

...
<div class="container mx-auto p-4 sm:p-6 lg:p-8">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-extrabold text-gray-900">Edit Ulasan</h1>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('ulasan.update', $ulasan->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                <label for="ulasan_text" class="block text-sm font-medium text-gray-700">Ulasan</label>
            ...
            <div>
                ...
                <input type="number" name="rating" id="rating"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                       min="1" max="5" value="{{ old('rating', $ulasan->rating) }}" required>
            </div>

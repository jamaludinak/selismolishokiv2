...
<div class="container mx-auto p-4 sm:p-6 lg:p-8">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-extrabold text-gray-900">Tambah Pelanggan Baru</h1>
        ...
        <form action="{{ route('pelanggan.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="kode" id="kode"
                       ...
                       placeholder="Masukkan kode pelanggan (otomatis jika kosong)" value="{{ old('kode') }}">
            </div>
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                       placeholder="Masukkan nama lengkap pelanggan" value="{{ old('nama') }}" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="noHP" id="noHP"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                       placeholder="Masukkan nomor telepon pelanggan" value="{{ old('noHP') }}" required>
            </div>
            ...
            <div>
                ...
                <textarea name="keluhan" id="keluhan" rows="3"
                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
                          placeholder="Masukkan keluhan pelanggan (opsional)">{{ old('keluhan') }}</textarea>
            </div>

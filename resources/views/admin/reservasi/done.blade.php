...
@section('content')
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div
            ...
            <div>
                <h2 class="text-3xl font-extrabold text-white mb-2">Riwayat Reservasi Selesai</h2>
                <p class="text-orange-100">Lihat dan kelola riwayat reservasi yang sudah selesai di sistem Anda</p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-8">
            <form class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 items-end" method="GET"
                action="{{ route('admin.reservasi.history') }}">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="kodePelanggan" id="kodePelanggan" placeholder="Contoh: P123"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
            ...
            @forelse ($reservasis as $reservasi)
                <div class="bg-white rounded-lg shadow-md border border-gray-200 p-5 relative">
                    ...
                    <div class="flex flex-col space-y-3 mt-5">
                        ...
                        <button type="button" onclick="confirmDeleteHistory({{ $reservasi->id }})"
                        ...
                        <form id="delete-history-form-{{ $reservasi->id }}"
            ...
            <table class="min-w-max divide-y divide-gray-200">
                <thead class="bg-orange-600">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Nama Lengkap
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Alamat</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">No. Telp
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Jenis
                            Kerusakan</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Servis</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">No. Resi
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Teknisi
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Aksi</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-6 py-4 whitespace-nowrap text-center text-lg text-gray-500">
